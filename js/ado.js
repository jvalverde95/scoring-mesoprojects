...
function cfgAdoStatusShow(type,msg){
  const el=document.getElementById('cfg-ado-status'), sp=document.getElementById('cfg-ado-spinner'), ml=document.getElementById('cfg-ado-status-msg');
...
function cfgAdoSaveCreds(){
  ...
  toast('Credenciales sincronizadas');
}
